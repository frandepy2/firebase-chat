...
abstract class $ErrorModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, String code, DateTime timestamp});
}
...
class _$ErrorModelImpl implements _ErrorModel {
  const _$ErrorModelImpl(
      {required this.message, required this.code, required this.timestamp});
  ...
  @override
  String toString() {
    return 'ErrorModel(message: $message, code: $code, timestamp: $timestamp)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, message, code, timestamp);
...
abstract class _ErrorModel implements ErrorModel {
  const factory _ErrorModel(
      ...
      required final DateTime timestamp}) = _$ErrorModelImpl;
